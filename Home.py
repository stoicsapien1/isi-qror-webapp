...
def main():
    ...
    st.write('''The Master of Technology (M.Tech) in QROR is a full-time program offered at the Indian Statistical Institute (ISI) in Kolkata. 
             This specialized program aims to produce experts in Data Science/Analytics, Artificial Intelligence, Survival Analysis, Machine Learning , and Statistical Quality Control.''')
